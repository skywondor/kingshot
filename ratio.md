[Home](README.md) / Troop ratio

# Troop ratio / Ratio troupes

## Understand / Comprendre

### English
Depending on the battle to be fought, the troop ratio between infantry, cavalry and archers should not be the same.

### Français
Selon le combat à mener, le ratio troupe entre infanterie, cavalier et archer ne doit pas être le même.

## Ratios

### English
| Event | Infantry | Cavalry | Archer |
|-------|------------|----------|--------|
| Bear hunt, create rally | 10% | 10% | 80% |
| Bear hunt, join rally   | 33% | 33% | 34% |
| Alliance championship | 50% | 20% | 30% |
| Swordland | 50% | 20% | 30% |
| Battles | 50% | 20% | 30% |
...
|-------|------------|----------|--------|
| Chasse à l'ours, ouvrir rallye | 10% | 10% | 80% |
| Chasse à l'ours, rejoindre rallye | 33% | 33% | 34% |
| Championnat alliance | 50% | 20% | 30% |
| Glaive | 50% | 20% | 30% |
| Battailles | 50% | 20% | 30% |
